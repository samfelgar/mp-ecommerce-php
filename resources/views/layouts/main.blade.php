...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/category-landing.css') }}" media="screen, print">

    <link rel="stylesheet" href="{{ asset('assets/category.css') }}" media="screen, print">

    <link rel="stylesheet" href="{{ asset('assets/merch-tools.css') }}" media="screen, print">

    <link rel="stylesheet" href="{{ asset('assets/fonts') }}" media="">
                    ...
                    <div class="pd-billboard pd-category-header">
                        <div class="pd-l-plate-scale">
                            <div class="pd-billboard-background">
                                <img src="{{ asset('assets/music-audio-alp-201709') }}" alt="" width="1440" height="320"
